      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden sm:block w-64">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border-subtle bg-bg-secondary py-1.5 pl-10 pr-4 text-xs text-text-primary outline-none transition-all placeholder:text-text-tertiary focus:border-accent-blue/30 focus:bg-bg-primary focus:ring-2 focus:ring-accent-blue/10"
          />
          <div className="absolute right-3.5 top-1/2 -translate-y-1/2 rounded bg-border-medium px-1.5 py-0.5 text-[10px] font-medium text-text-secondary tracking-widest">
            ⌘K
          </div>
        </div>
