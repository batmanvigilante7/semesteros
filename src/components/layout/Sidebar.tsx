    ...
    <>
      ...
      >
        ...
        <div className="border-t border-border-subtle p-4">
          <div className={`flex items-center gap-3 rounded-xl p-2 hover:bg-bg-secondary/50 transition-colors duration-200 ${isCollapsed ? 'justify-center' : ''}`}>
            <div className="relative h-9 w-9 shrink-0 overflow-hidden rounded-full bg-accent-indigo text-white flex items-center justify-center font-bold text-sm shadow-subtle">
              HS
            </div>
            {!isCollapsed && (
